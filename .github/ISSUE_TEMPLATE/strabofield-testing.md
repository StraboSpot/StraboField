---
name: StraboField testing
about: 'Step by Step testing protocol for StraboField '
...
## Application Testing
Your time and insights have already made an irreplaceable impact—every bit of feedback helps our developers fix issues and improve StraboField. Thanks again for your continued support—we truly couldn’t do this without you. 

Please follow the steps below and record any notes, questions or concerns along the way. If any testing step does not function as intended please record notes in this testing template. Following the completion of the testing protocol please submit all issues as separate 'issues' in the StraboField GitHub repository. 
...
- [ ] If your device has a “back” button, does the “back” button take user to the previous screen?
