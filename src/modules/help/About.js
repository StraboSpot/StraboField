      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.content} style={styles.descriptionContainer}>
          ...
          <Text style={styles.paragraph}>
            ...
            {'\n\n'}
            You can also organize interpretations using <Text style={styles.bold}>Tags</Text> — flexible labels like *geologic units*, *metamorphic grade*, or *fold generations* that apply to multiple spots across varied areas.
          </Text>
