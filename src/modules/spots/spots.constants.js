...
export const FILTERS = {
  ...
  MAPPED_ON_GEOGRAPHIC_MAP: 'MAPPED_ON_GEOGRAPHIC_MAP',
...
export const FILTER_LABELS = {
  ...
  [FILTERS.MAPPED_ON_GEOGRAPHIC_MAP]: 'On the Geographic Map',
